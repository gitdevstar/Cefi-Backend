...
@section('title', 'Bank Charge Transactions')
...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <table class="table table-striped table-bordered dataTable bankcharge-table">
            </table>
        </div>
    </div>
</div>
...
$(document).ready(function(){
    ...
    var table = $('.bankcharge-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
          url: "{{ route('admin.cash.bankcharge.history') }}"
        },
        order: [[0, 'desc']],
        columns: [
